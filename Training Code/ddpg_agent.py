...
class Agent():
    ...
    def act(self, state, add_noise=True):
        ...
        self.actor_local.eval() #Dropout and BatchNorm (and maybe some custom modules) behave differently during training and evaluation. You must let the model know when to switch to eval mode by calling .eval() on the model.
